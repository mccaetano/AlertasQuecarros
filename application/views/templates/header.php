...
HTML;
	...
	echo "										<li><a href=\"" . base_url() . "login/alterasenha\"><i class=\"icon-edit\"></i> Alterar Senha</a></li>";
	echo "										<li><a href=\"" . base_url() . "usuario/cacnelarEmail/" . urlencode($email) . "\"><i class=\"icon-remove-circle\"></i> Cancelar Alertas</a></li>";
	echo <<<HTML
										  </ul>
									</div>
								</div>
