	...
	<form id="boxFormAlerta" action="#">
		<div style="width: 860px;">
			...
			<div>
				...
				<input id="email" type="text" style="font-size: 18px; color: red;background-color: #CCCCCC;padding: 5px 5px 5px 5px;border: 1px solid red; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; -webkit-box-shadow: 0px 0px 4px red; -moz-box-shadow: 0px 0px 4px red; box-shadow: 0px 0px 7px #FF9E9E;"
